...
def params_args(args=None):
    ...
    params.add_argument("-b", "--batch_size", type=int, default=100,
                        help="Mini batch size for training , when using async mode, "
                             "change batch size to default * thread")
    params.add_argument("-e", "--epochs", type=int, default=2,
                        help="Number of epochs for training.")

    # customized parameters
    params.add_argument('--embedding_size', type=int, default=10,
                        help="The size for embedding layer (default:10)")
    params.add_argument("--num_field", type=int, default=39)
    params.add_argument("--num_feat", type=int, default=1086460)
    params.add_argument("--reg", type=float, default=1e-4)
    params.add_argument('--layer_sizes', nargs='+', type=int, default=[400, 400, 400],
                        help='The size of each layers (default: [400, 400, 400])')
    params.add_argument("--act", type=str, default='relu')
    ...
    params.add_argument('--test', type=bool, default=False, help='support model save')
    ...
    params.add_argument("--sync_mode", type=str, default="", choices=["sync", "async", "half_async"])
