...
def train(args):
    ...
    if args.checkpoint is not None:
        tmp_s = fleet.load_checkpoint(exe, args.checkpoint, main_program=train_prog)
    ...
    print("train_batch_size: %d device_num:%d total_batch_size" % (train_batch_size, device_num, args.total_batch_size))
    ...
    if trainer_id == 0:
        ...
        if args.checkpoint:
            fleet.save_check_point(executor=exe, epoch_no=pass_id, 
