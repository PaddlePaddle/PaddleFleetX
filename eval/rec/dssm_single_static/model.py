...
class DSSMLayer(nn.Layer):
    ...
    def forward(self, input_data, is_infer=False):
...
class DSSMModel:
    def __init__(self, trigram_d=2900, neg_num=1, hidden_layers=[300, 300, 128], hidden_acts=['relu', 'relu', 'relu'], slice_end=8):
        self.trigram_d = trigram_d
