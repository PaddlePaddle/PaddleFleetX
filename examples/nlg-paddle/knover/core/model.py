...
class Model(ABC):
    ...
    def add_cmdline_args(cls, parser):
        ...
        group.add_argument("--without_graph_optimization", type=str2bool, default=True,
                           help="Whether to disable graph optimization.")
    ...
    def __init__(self, args, place):
        ...
        self.without_graph_optimization = args.without_graph_optimization
            ...
            with paddle.static.program_guard(self.train_program, self.startup_program):
                with paddle.utils.unique_name.guard():
                    ...
                    if self.is_distributed and self.use_amp:
                        vars_ = paddle.static.default_main_program().global_block().vars
    ...
    def optimize(self, metrics):
        ...
        if self.lr_scheduler == "noam" and self.warmup_steps > 0:
            ...
            scheduled_lr = paddle.static.create_global_var(
        ...
        optimize_ops, params_grads = optimizer.minimize(metrics["loss"])
        for param, grad in params_grads:
            rank = fleet.worker_index()
            if param.name in [
                    f"encoder_layer_0_ffn_fc_0_e{rank}.w_0",
                    f"encoder_layer_1_ffn_fc_0.w_0",
            ]:
                paddle.static.Print(grad)
        return scheduled_lr
