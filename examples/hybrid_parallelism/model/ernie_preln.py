...
from model.transformer_encoder_preln import encoder, pre_process_layer
from model.transformer_encoder_preln import gelu
...
class ErnieModel(object):
    ...
    def get_next_sentence_output(self, labels):
        ...
        next_sent_fc_out = fluid.layers.fc(
            ...
            size=33,
            param_attr=fluid.ParamAttr(
                name="multi_sent_fc.w_0", initializer=self._param_initializer),
            bias_attr="multi_sent_fc.b_0")
