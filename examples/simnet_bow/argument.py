...
def params_args(args=None):
    ...
    params.add_argument("--decay_steps", type=int, default=2,
                        help="Decay the learning rate after every N epochs.")
    params.add_argument("--decay_rate", type=float, default=0.99,
                        help='Rate of decaying the learning rate.')
    params.add_argument("--random_seed", type=int, default=0,
