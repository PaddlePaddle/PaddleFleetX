...
def main():
    ...
    with open("./output/auto_search_4" + "/auto_main_program.txt.%d" % (paddle.distributed.get_rank()), 'w') as f:
        f.write(str(dist_main_prog))
    with open("./output/auto_search_4" + "/auto_startup_program.txt.%d" % (paddle.distributed.get_rank()), 'w') as f:
