...
def main(args):
    ...
    from model_utils.ops import Topology
    ...
    if args.pp_degree < 2:
        ...
        for eval_step, batch in enumerate(train_data_loader):
            ...
            print("step: ", eval_step, "loss: ", np.asarray(loss))
...
def create_data_loader(args, data_holders, topo):
    ...
    from model_utils.transformers import GPTTokenizer, GPTChineseTokenizer
