...
class JiebaTokenizer(BaseTokenizer):
    ...
    Args:
        vocab(model_utils.data.Vocab): An instance of :class:`model_utils.data.Vocab`.
    """
    ...
    def cut(self, sentence, cut_all=False, use_hmm=True):
        ...
        Example:
            .. code-block:: python
                ...
                from model_uitls.data import Vocab, JiebaTokenizer
    ...
    def encode(self, sentence, cut_all=False, use_hmm=True):
        ...
        Example:
            .. code-block:: python
                ...
                from model_utils.data import Vocab, JiebaTokenizer
                # The vocab file. The sample file can be downloaded firstly.
                # wget https://paddlenlp.bj.bcebos.com/data/senta_word_dict.txt
                vocab_file_path = './senta_word_dict.txt'
                # Initialize the Vocab
