    ...
    def __call__(self, data):
        ...
        Example:
            .. code-block:: python
                ...
                from model_utils.data import Stack
                a = [1, 2, 3, 4]
                b = [3, 4, 5, 6]
                c = [5, 6, 7, 8]
                result = Stack()([a, b, c])
    ...
    def __call__(self, data):
        ...
        Example:
            .. code-block:: python
                ...
                from model_utils.data import Pad
                a = [1, 2, 3, 4]
                b = [5, 6, 7]
                c = [8, 9]
    ...
    def __call__(self, data):
        ...
        Example:
            .. code-block:: python
                ...
                from model_utils.data import Stack, Pad, Tuple
                data = [
                        [[1, 2, 3, 4], [1]],
                        [[5, 6, 7], [0]],
                        [[8, 9], [1]],
    ...
    def __call__(self, data):
        ...
        Example:
            .. code-block:: python
                ...
                from model_utils.data import Stack, Pad, Dict
                data = [
