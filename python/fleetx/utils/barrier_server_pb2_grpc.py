...
import barrier_server_pb2 as barrier__server__pb2
...
class BarrierServer(object):
    ...
    def ReadyToPass(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/barrier.BarrierServer/ReadyToPass',
            barrier__server__pb2.Request.SerializeToString,
            barrier__server__pb2.Res.FromString,
    ...
    def Exit(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/barrier.BarrierServer/Exit',
            barrier__server__pb2.Request.SerializeToString,
            barrier__server__pb2.Res.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/barrier.BarrierServer/SayHello',
            barrier__server__pb2.Request.SerializeToString,
            barrier__server__pb2.Res.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
