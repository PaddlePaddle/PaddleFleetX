...
class BarrierServer(object):
    ...
    def _start_func(self, port, worker_endpoints):
        ...
        barrier_server._start(
            endpoint=port, worker_endpoints=worker_endpoints)
    ...
    def start_server_in_background(self,
        ...
        self.p = Process(target=self._start_func, args=(endpoint, worker_endpoints))
        self.p.start()
...
if __name__ == "__main__":
    ...
    barrier_server.start_server_in_background(endpoint=server_endpoint,
