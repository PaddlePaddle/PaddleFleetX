...
from .clip_modules import normal_init, Transformer, VisionTransformer, AttentionPool2D
...
def clip_vit_base_32(**kwargs):
    model = CLIP(embed_dim=512,
                ...
                transformer_layers=12, qkv_bias=True, pre_norm=True,
                proj=True, patch_bias=False, **kwargs)
    return model
