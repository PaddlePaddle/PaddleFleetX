...
from ppfleetx.data.tokenizers.t5_tokenization_utils_base import (
    _LazyConfigMapping,
    AddedToken,
    TruncationStrategy,
    PaddingStrategy,
...
class T5Tokenizer(SpecialTokensMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *init_inputs, **kwargs):
        ...
        if os.path.isfile(pretrained_model_name_or_path):
            ...
            vocab_files_target = {**cls.vocab_files_names, **cls.config_files_names, **additional_files_names}
        ...
        **kwargs
        ...
        if config_tokenizer_class is None:
            ...
            if config_tokenizer_class is None:
                ...
                from ppfleetx.data.tokenizers.t5_tokenization_utils_base import TOKENIZER_MAPPING_NAMES  # tests_ignore
    ...
    def _eventual_warn_about_too_long_sequence(self, ids, max_length, verbose: bool):
        """
