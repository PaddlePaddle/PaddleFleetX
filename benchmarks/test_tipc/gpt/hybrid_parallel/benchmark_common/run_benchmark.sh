...
function _train(){
    ...
    train_cmd="-c ./configs_1.3B_dp8.yaml \
               -o Global.seed=1234 \
               ...
               -o Data.batch_size.local_batch_size=${local_batch_size} \
               -o Data.batch_size.micro_batch_size=${micro_batch_size} \
    ...
    cd ../examples/gpt/hybrid_parallel/
